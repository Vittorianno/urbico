...
// Map backend variables to their Expo public (client-safe) equivalent, so
// setting the backend var once in .env is enough - no need to duplicate the
// same public value under two different names.
const mappings = {
