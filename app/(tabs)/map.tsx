...
const styles = StyleSheet.create({
  ...
  attribution: { position: "absolute", left: 8, bottom: 7, color: "#294057", backgroundColor: "rgba(255,255,255,0.82)", borderRadius: 4, paddingHorizontal: 5, paddingVertical: 2, fontSize: 9 },
