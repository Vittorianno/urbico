...
export default function ProfileScreen() {
  ...
  // FIX: o item "Lotação" nas Preferências foi removido de propósito. A
  // lotação deixou de ser uma funcionalidade própria (tela/menu) — agora é
  // um atributo contextual mostrado junto de cada opção de ônibus durante o
  // planejamento de uma viagem (ver next-buses.tsx e o fluxo do Norby).
